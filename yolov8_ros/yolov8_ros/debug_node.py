...
class DebugNode(LifecycleNode):
    ...
    def on_configure(self, state: LifecycleState) -> TransitionCallbackReturn:
        ...
        self._dbg_compressed_pub = self.create_publisher(CompressedImage, "compressed/dbg_image", 10)
    ...
    def on_cleanup(self, state: LifecycleState) -> TransitionCallbackReturn:
        ...
        self.destroy_publisher(self._dbg_compressed_pub)
    ...
    def detections_cb(self, img_msg: Image, detection_msg: DetectionArray) -> None:
        ...
        self._dbg_compressed_pub.publish(self.cv_bridge.cv2_to_compressed_imgmsg(cv_image))
